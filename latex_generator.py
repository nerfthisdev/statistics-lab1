import math
from variation_series import get_expected_value_estimate, get_inverse_laplace, get_sample_standard_deviation_corrected, get_variation_series
...
def get_confidence_interval_for_expvalue_large_set_with_latex_steps(average_value: float, n: int, sigma: float, confidence_prob: float) -> tuple[float, float]:
